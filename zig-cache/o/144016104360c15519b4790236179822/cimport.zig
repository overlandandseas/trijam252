...
pub const va_start = @compileError("unable to translate macro: undefined identifier `__builtin_va_start`"); // /opt/homebrew/Cellar/emscripten/3.1.51/libexec/cache/sysroot/include/stdarg.h:12:9
pub const va_end = @compileError("unable to translate macro: undefined identifier `__builtin_va_end`"); // /opt/homebrew/Cellar/emscripten/3.1.51/libexec/cache/sysroot/include/stdarg.h:13:9
pub const va_arg = @compileError("unable to translate C expr: unexpected token 'an identifier'"); // /opt/homebrew/Cellar/emscripten/3.1.51/libexec/cache/sysroot/include/stdarg.h:14:9
pub const va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`"); // /opt/homebrew/Cellar/emscripten/3.1.51/libexec/cache/sysroot/include/stdarg.h:15:9
...
pub const __restrict = @compileError("unable to translate C expr: unexpected token 'restrict'"); // /opt/homebrew/Cellar/emscripten/3.1.51/libexec/cache/sysroot/include/features.h:27:9
pub const __inline = @compileError("unable to translate C expr: unexpected token 'inline'"); // /opt/homebrew/Cellar/emscripten/3.1.51/libexec/cache/sysroot/include/features.h:33:9
pub const __REDIR = @compileError("unable to translate C expr: unexpected token '__typeof__'"); // /opt/homebrew/Cellar/emscripten/3.1.51/libexec/cache/sysroot/include/features.h:45:9
pub const HUGE_VALL = @compileError("unable to translate: TODO long double"); // /opt/homebrew/Cellar/emscripten/3.1.51/libexec/cache/sysroot/include/math.h:24:9
pub const __ISREL_DEF = @compileError("unable to translate macro: undefined identifier `__is`"); // /opt/homebrew/Cellar/emscripten/3.1.51/libexec/cache/sysroot/include/math.h:104:9
pub const __tg_pred_2 = @compileError("unable to translate macro: undefined identifier `f`"); // /opt/homebrew/Cellar/emscripten/3.1.51/libexec/cache/sysroot/include/math.h:124:9
